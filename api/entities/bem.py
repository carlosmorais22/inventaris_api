class Bem():
    ...
    def __init__(self, descricao, setor, tombo, conta, estado, estado_descricao, valor, valor_remanescente, numero_serie, data, data_aquisicao, ativo, inventariado=None, id=None):
